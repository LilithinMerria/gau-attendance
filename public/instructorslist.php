...
<body>
	...
	<div class="container">
		...
		?>
		<br>
		<h3 class="display-5" style="font-family: Poppins">&nbsp;Instructors List</h3>
		<br>
		...
		?>
			<tbody>
				<tr>
					...
					<td><a class="btn btn-danger" style="color:#fff" href="deleteinstructor.php?id=<?php echo $row["Staff_id"]; ?>">Delete</td>
				</tr>
		</tbody>
		<?php
			}
