...
<head>
	...
	<title>Insert Student Attendance</title>
...
<body>
	...
	<div class="container">
		...
		<br>
		<h3 class="display-5" style="font-family: Poppins">&nbsp;Insert Student Attendance</h3> <br>
		...
		?>
			...
			<div class="radio-buttons" style="float:right;">
				<input type="radio" name="<?php echo $row3['Std_id'] ?>" value="1" required>
				<label>Attended</label>
				<input type="radio" name="<?php echo $row3['Std_id'] ?>" value="2">
				<label>Not Attended</label>
				<input type="radio" name="<?php echo $row3['Std_id'] ?>" value="3">
